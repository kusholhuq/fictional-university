        ...
        'groups' => array(
             ...
             array(
                'args' => array(
                    ...
                    'id' => 'social-api',
                    'class' => '',
                    'desc' => __("Follow <a href='http://guides.enginethemes.com/knowledge-base/fre-setup-the-social-login-feature/' target='_blank'>this tutorial post</a> to setup social login API.<br /> <p> &nbsp</p>", ET_DOMAIN)
                ) ,
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'twitter-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Twitter. Go to < href = 'https://developer.twitter.com/en/apps' target ='_blank'> Twitter Developer </a>", ET_DOMAIN)
                ) ,
